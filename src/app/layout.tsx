...
export async function generateMetadata(): Promise<Metadata> {
  ...
  try {
    ...
    return {
      ...
      title: {
        default: settings.metaTitle || settings.brandName || "RPL Market",
        template: `%s | ${settings.brandName || "RPL Market"}`,
      },
      ...
      appleWebApp: {
        ...
        title: settings.brandName || "RPL Market",
      },
      formatDetection: {
        telephone: false,
      },
      openGraph: {
        title: settings.metaTitle || settings.brandName || "RPL Market",
        description: settings.metaDescription || settings.brandName || "Your ultimate destination for quality products.",
        url: baseUrl,
        siteName: settings.brandName || "RPL Market",
        type: 'website',
      },
      twitter: {
