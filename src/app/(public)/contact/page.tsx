...
export const metadata: Metadata = {
  title: 'Contact Us | RPL Market',
  description: 'Get in touch with RPL Market for any inquiries, support, or feedback.',
};
